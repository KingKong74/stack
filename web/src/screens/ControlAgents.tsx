  ...
  return (
    <div className="mc-agentsroom">
      <div className="mc14-room-head">
        ...
        <span className="meta">
          {/* "surface", not "tab": #375's Foreman and #363's Merge agent are
              bound to Mission Control ROOMS, so "one per tab" undercounts and
              names a screen two of the five do not have. */}
          {!data ? 'loading…' : `${liveCount} of ${data.agents.length} on · one per surface · ${formatUsd(totalSpend)} spent`}
        </span>
      </div>
