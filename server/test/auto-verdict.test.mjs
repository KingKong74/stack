...

{
  const ev = {
    ...
    reviewBugs: 0,
    changed: ['server/src/routes/roadmap.js', 'web/src/screens/ControlReview.tsx',
...
check('a directory declaration covers a file beneath it',
  unconfined(['web/src/screens/ControlReview.tsx'], ['web/src']), []);
...
{
  const text = 'Interfaces: server/src/routes/roadmap.js (PATCH), web/src/screens/ControlReview.tsx';
  check('declaredFiles pulls both paths and skips the rest',
    declaredFiles(text),
    ['server/src/routes/roadmap.js', 'web/src/screens/ControlReview.tsx']);
}
