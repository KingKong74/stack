...
autopilot.post('/runs', async (req, res) => {
  ...
  const { rows } = await q(
    `INSERT INTO autopilot_runs
       (project_id, item_id, item_title, branch, outcome, commits, tokens, cost_usd, checks_failing, summary, model_usage, tmux_session, review_verdict, review_note, review_findings, auto_verdict, started_at)
    ...
    [
      ...
      tmuxSession,
      reviewVerdict, reviewNote, reviewFindings, autoVerdict,
