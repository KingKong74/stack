...
function nightRunShape(r) {
  return {
    ...
    // (#266) gave it one, else the UTC day it finished. A fanned night can
    // cross midnight, so "when it finished" is no longer "which night it
    // was" — night_key is, and the SELECT that feeds this computes it.
    day: r.night_key || '',
